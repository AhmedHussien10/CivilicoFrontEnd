      ...
      <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
        ...
        <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6 w-full md:w-auto">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 w-full md:w-auto">
            <button className="bg-[#3B5F5D] text-white px-4 py-2 rounded-3xl font-semibold w-full sm:w-[160px] h-[65px] shadow-[6px_8px_16px_rgba(0,0,0,0.3)] hover:shadow-[8px_10px_20px_rgba(0,0,0,0.3)] transition duration-300 hover:bg-[#C28E21] transition duration-300">
              Log in
            </button>
            <button className="bg-[#3B5F5D] text-white px-4 py-2 rounded-3xl font-semibold w-full sm:w-[160px] h-[65px] shadow-[6px_8px_16px_rgba(0,0,0,0.3)] hover:shadow-[8px_10px_20px_rgba(0,0,0,0.3)] transition duration-300 hover:bg-[#C28E21] transition duration-300">
              Sign up
